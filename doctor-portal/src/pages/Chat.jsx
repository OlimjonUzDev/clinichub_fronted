...
export default function Chat() {
  ...
  // Sarlavhada qaysi bemor/sana bilan suhbat ekani ko'rinsin — chat funksionalligi
  ...
  const patientName = appointment ? resolveName(appointment.patient, patients, lang) : null;
