...
const LogoIcon = () => (
  <svg width="44" height="48" viewBox="0 0 44 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M22 2L3 12V30C3 39.4 11.5 46 22 48C32.5 46 41 39.4 41 30V12L22 2Z" fill="#F0FDFA" stroke="#0D9488" strokeWidth="1.5"/>
    <rect x="14" y="14" width="16" height="16" rx="3" fill="#0D9488" opacity="0.15"/>
    <path d="M22 16V26M17 21H27" stroke="#0D9488" strokeWidth="2" strokeLinecap="round"/>
    <path d="M14 32C14 32 16.5 36 22 36C27.5 36 30 32 30 32" stroke="#0D9488" strokeWidth="1.8" strokeLinecap="round"/>
    <circle cx="30" cy="34" r="3" fill="#0D9488"/>
  </svg>
);
